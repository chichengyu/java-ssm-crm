            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                        <c:forEach items="${paging.list}" var="row">
                            <tr>
                                <td>${row.custId}</td>
                                <td>${row.custName}</td>
        ...
        <div class="container">
            <div class="row clearfix">
                <div class="col-md-12 column">
                    <ul class="pagination">
                        <li>
                            <a href="${pageContext.request.contextPath}/customer/list?page=${paging.prePage<=0?1:paging.prePage}">Prev</a>
                        </li>
                        <c:forEach begin="1" end="${paging.pages}" var="i">
                            <li class="page-item ${paging.pageNum==i?"disabled active":""}">
                                <a href="${pageContext.request.contextPath }/customer/list?page=${i}">${i}</a>
                            </li>
                        </c:forEach>
                        <li>
                            <a href="${pageContext.request.contextPath}/customer/list?page=${paging.pageNum==paging.pages?paging.pages:paging.nextPage}">Next</a>
                        </li>
                    </ul>
                </div>
            </div>
